...
type InputProps = Required<
    Pick<
        ...
        'value' | 'onChange' | 'onFocus' | 'onBlur' | 'onKeyDown' | 'onPaste' | 'aria-label' | 'autoComplete' | 'style' | 'inputMode' | 'onInput'
    > & {
        ref: React.RefCallback<HTMLInputElement> | any;
...
const OTPInput = ({
    ...
    const getPlaceholderValue = () => {
        if (typeof placeholder === 'string') {
            ...
            if (placeholder.length > 0) {
                logError('Length of the placeholder should be equal to the number of inputs.');
            }
        }
        return undefined;
    };
    ...
    const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (isInputValueValid(val)) {
            ...
            if (value !== '') focusInput(activeInput + 1);
        }
    };
